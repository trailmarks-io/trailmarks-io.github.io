...
layout: default
lang: en
title: "The Future of Trail Stones"
description: "Discover the fascinating history of trail stones and how Trailmarks.io is creating new paths for modern hiking experiences."
---
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-gray-900 leading-tight mb-6">
                    The Future of
                    <span class="text-trailmark-blue">Trail Stones</span>
                </h1>
                <p class="text-xl text-gray-600 mb-8 leading-relaxed">
                    For centuries, stones have guided travelers through unknown paths. 
                    With Trailmarks.io, we're creating a new era of trail markers – 
                    digital, sustainable, and accessible to everyone.
                </p>
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="#story" class="btn-primary inline-flex items-center justify-center">
                        Discover Our Story
                ...
                <div class="relative">
                    ...
                    <div class="bg-gradient-to-br from-trailmark-blue to-trailmark-green rounded-2xl aspect-square flex items-center justify-center shadow-2xl">
                        <div class="text-center text-white">
                            ...
                            <p class="text-lg font-medium opacity-90">Digital Trail Stones</p>
                        </div>
                    </div>
                    <!-- Decorative elements -->
